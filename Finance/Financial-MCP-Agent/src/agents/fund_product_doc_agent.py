    ...
    "source_summary": "数据来源简述"
        ...
        try:
            ...
            if sp is None:
                ...
                sp = text_to_signal_pack(final_output, "fund_product_doc", current_date)
        ...
        if not skip_cache and cache_date and cache_code:
            ...
            if "fund_product_doc_signal_pack" in current_data:
                from src.utils.cache_utils import write_signal_pack_cache
                write_signal_pack_cache("fund_product_doc", cache_code, cache_date, current_data["fund_product_doc_signal_pack"])
        current_metadata["fund_product_doc_executed"] = True
