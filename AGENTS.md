...
6. Update `评分智能体开发总纲.md` if changing ablation structure (keep AGENTS.md in sync)
...
- **Do NOT modify 总纲 without updating AGENTS.md** — the two documents must stay in sync on architecture, constraints, and design decisions.
